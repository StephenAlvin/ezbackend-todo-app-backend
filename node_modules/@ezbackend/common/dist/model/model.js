    ...
    Object.entries(schema).forEach(function (_a) {
        ...
        if (isNestedNormalType(value)) {
            if (value.primary === true) {
                throw new utils_1.EzError("EzBackend currently only supports one Primary Column per entity", "A primary id column is created by default for all models. While typeorm supports composite primary keys, EzBackend currently does not support this feature. If you need it drop us a message in github", (0, dedent_js_1.default)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n                    new EzModel(\"IllegalModel\", {\n                        mySecondPrimaryColumn: {\n                            type: Type.VARCHAR,\n                            primary: true //This is illegal\n                        }\n                    })"], ["\n                    new EzModel(\"IllegalModel\", {\n                        mySecondPrimaryColumn: {\n                            type: Type.VARCHAR,\n                            primary: true //This is illegal\n                        }\n                    })"]))));
            }
            var type = value.type, noType = __rest(value, ["type"]);
            columns[key] = __assign({ type: normalTypeToTypeORMtype(value.type) }, noType);
        }
        if (isRelation(value)) {
            throw new utils_1.EzError("You currently need to use the full declaration for specifying a relation", "Relations require additional metadata to generate the Database Tables", (0, dedent_js_1.default)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n                Replace\n\n                myRelation: Type.ONE_TO_ONE\n\n                With\n\n                myRelation: {\n                    type: Type.ONE_TO_ONE,\n                    joinColumn: true,\n                    target:'detail'\n                },\n                "], ["\n                Replace\n\n                myRelation: Type.ONE_TO_ONE\n\n                With\n\n                myRelation: {\n                    type: Type.ONE_TO_ONE,\n                    joinColumn: true,\n                    target:'detail'\n                },\n                "]))));
