...
function createRulesSubscriber(ezRules) {
    ...
    function getFastifyRequest() {
        return fastify_request_context_1.requestContext.get(context_1.REALTIME.REQ_CONTEXT);
    }
    function getSocketRequest() {
        return socket_io_event_context_1.socketContext.get(context_1.REALTIME.SOCKET_CONTEXT);
    }
    ...
    return (0, model_1.DecorateClass)((0, typeorm_1.EventSubscriber)(), RuleSubscriber);
}
